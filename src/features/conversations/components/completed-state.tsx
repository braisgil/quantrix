...
import { CallProvider } from "@/features/call/component/call-provider";

interface Props {
  data: ConversationGetOne;
}
    ...
    <div className="flex flex-col gap-y-4">
      <Tabs defaultValue="summary">
        ...
        <TabsContent value="chat">
          <CallProvider conversationId={data.id} conversationName={data.name} />
        </TabsContent>
        <TabsContent value="transcript">
          <Transcript conversationId={data.id} />
        </TabsContent>
